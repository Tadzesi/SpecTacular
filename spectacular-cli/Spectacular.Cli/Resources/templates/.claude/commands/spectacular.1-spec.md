...
### 4. Codebase Analysis (Before Writing Spec)

Before writing the spec, actively investigate the project:
...
- Recommend the best approach given what's already in place
- Define what this spec should explicitly NOT cover
...
Explicit out of scope: [what to exclude to prevent scope creep]
Risks: [any flags]
```
